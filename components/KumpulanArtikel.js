    ...
    <>
        <div className="lg:container mx-auto">
            ...
            <div className="w-full items-start grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 lg:gap-4 p-5 md:px-16 md:pt-10">
                <CardArtikel gambar={VaksinJokowi} judul="Penting, Berikut 4 Manfaat Vaksin Covid-19 Yang Perlu Diketahui"
                ...
                <CardArtikel gambar={Edukasi5M} judul="Mengenal Protokol Kesehatan 5M Untuk Cegah COVID-19"
